  ...
  return (
    <div className="min-h-screen p-8">
      ...
      <div className="flex gap-4 mt-8">
        <a href="/predictive" className="bg-yellow-600 hover:bg-yellow-700 px-6 py-3 rounded-lg font-semibold">
          Predictive Maintenance
        </a>
        <a href="/esg" className="bg-green-600 hover:bg-green-700 px-6 py-3 rounded-lg font-semibold">
          ESG / Carbon
        </a>
      </div>
    </div>
