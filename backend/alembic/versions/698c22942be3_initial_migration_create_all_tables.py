...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_raw_measurements_machine_id"), "raw_measurements", ["machine_id"], unique=False
    )
    op.create_index(
        op.f("ix_raw_measurements_timestamp"), "raw_measurements", ["timestamp"], unique=False
    )
